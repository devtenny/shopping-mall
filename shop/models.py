...
class Category(models.Model):
    ...
    meta_description = models.TextField(blank=True)  # SEO(검색 엔진 최적화)를 위한 열
...
class Product(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2)  # 가격, 소수점 19, 4
    ...
    class Meta:
        ordering = ['-created']  # 최근 게시물 우선으로 정렬
